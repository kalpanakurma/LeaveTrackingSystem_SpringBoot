...
public class UserServiceImpl implements UserService {
	...
	public boolean isManager(String email) {
        // Implement logic to check if the user with the given email has the role of "manager"
        Optional<Users> user = userRepository.findByEmail(email); // Assuming you have a method to find a user by email
        return user != null && user.get().getRole().equals(Role.MANAGER);
    }
}
