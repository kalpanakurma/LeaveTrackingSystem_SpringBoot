...
if (userDto == null || userDto.getName() == null || userDto.getName().isEmpty() || userDto.getEmail() == null ||  userDto.getEmail().isEmpty()|| userDto.getPassword() == null ||  userDto.getPassword().isEmpty() || userDto.getPersonalEmail()==null || userDto.getPersonalEmail().isEmpty() || userDto.getMobileNo()==null || userDto.getMobileNo().isEmpty() || userDto.getDateOfJoining()==null || userDto.getManagerId()==null)
{
 ...
 StringBuilder errorMessage = new StringBuilder("Fields ");
                ...
                if (userDto.getPersonalEmail() == null ||  userDto.getPersonalEmail().isEmpty()) {
                    errorMessage.append("'personalEmail', ");
                }
                if (userDto.getMobileNo() == null ||  userDto.getMobileNo().isEmpty()) {
                    errorMessage.append("'mobileNo', ");
                }
                if (userDto.getDateOfJoining() == null ) {
                    errorMessage.append("'Date of joining', ");
                }
                if (userDto.getManagerId() == null ) {
                    errorMessage.append("'Manager id ', ");
                }
...
if (userDto == null || userDto.getName() == null || userDto.getName().isEmpty() || userDto.getEmail() == null ||  userDto.getEmail().isEmpty()|| userDto.getPassword() == null ||  userDto.getPassword().isEmpty() || userDto.getPersonalEmail()==null || userDto.getPersonalEmail().isEmpty() || userDto.getMobileNo()==null || userDto.getMobileNo().isEmpty() || userDto.getDateOfJoining()==null)
{
...
if (userService.isUserWithEmailExists(userDto.getEmail())) {
 ...
 // Api for manager login
    ...
    public ResponseEntity<BackendResponse> loginManager(@RequestBody LoginDto loginDto) {
        BackendResponse response = new BackendResponse();
        //checking for the fields if any are empty
...
//            checking whether he/she is mananger
            
            if (userService.isManager(loginDto.getEmail())==false) {
                response.setMessage("Unauthrized Access");
                response.setStatus("fail");
                response.setData("empty");
                return ResponseEntity.status(HttpStatus.BAD_REQUEST).body(response);
            }
    ...
    public List<Long> getAllManagerIds() {
        return managerService.getAllManagerIds();
    }
    // api to get all the managers details
    @GetMapping("/role/managers")
