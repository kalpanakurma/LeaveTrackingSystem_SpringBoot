...
public class EmployeeController {
    ...
    public ResponseEntity<BackendResponse> applyForLeave(@PathVariable(name="userId") Long employeeId,
        ...
        try {
            ...
            if (leaveApplicationDto.getStartDate() == null || leaveApplicationDto.getEndDate() == null || leaveApplicationDto.getReason() == null || leaveApplicationDto.getReason().isEmpty() || leaveApplicationDto.getLeavetype() == null || leaveApplicationDto.getLeavetype().isEmpty()) {
                ...
                if (leaveApplicationDto.getLeavetype() == null || leaveApplicationDto.getLeavetype().isEmpty()) {
